...
async function gettechnews() {
    const resp = await fetch("https://newsapi.org/v2/everything?q=internet&sortBy=publishedAt&language=en&pageSize=1&apiKey="+myapikey);
...
fimg="upload/blog_masonry_04.jpg";
    ...
    <div class="shadoweffect">
       <div class="shadow-desc">
           <div class="blog-meta">
               <span class="bg-green"><a href="./more.html?q=internet" title="">Internet</a></span>
    ...
    `; 
document.getElementById("internetnews").innerHTML=html;
